...
import com.dragon.multigame._RummyPull.Fragments.GameUsersPoint_bt;
...
//                                                    lnr_group_card.removeViewAt(j);
    ...
    private void OnClickListener(){
        ...
        findViewById(R.id.ivrefresh).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rotation_animation(findViewById(R.id.ivrefresh),R.anim.rotationback_animation);
               // checkMyCards();
               // API_CALL_status();
            }
        });
...
//
    ...
    private void rotation_animation(View viewById, int rotationback_animation) {

        Animation circle =  Functions.AnimationListner(context, rotationback_animation, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {

            }
        });
        viewById.setAnimation(circle);
        circle.startNow();
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                try {
                    ...
                    if(code.equalsIgnoreCase("200"))
                    {
                        ...
                        Log.d("Debug","Response of table"+table_users);
                     //   Log.d("Debug","Response of table"+table_id);
...
//                    showChatPopUP(user_id);
    ...
    private void ParseTableDetails(JSONObject tableObject) {
      //  Log.d("Debug","online");
        ...
        tableModel.setOnlineMembers(tableObject.optString("online_members","0"));//changes have to
    ...
    private void InitializeUsers
        ...
        if (user_id_player.equals("0")) {
            ...
            txtPlay.setText("");
            txtPlaywallet.setVisibility(View.INVISIBLE);//changes to wallet
...
//            if(!opponent_game_declare)
    ...
    private void CreateGroups(ArrayList<CardModel> cardImageList, int count) {
        ...
        com.dragon.multigame._Rummy.GameLocalLogic gameLocalLogic = GameLocalLogic.getInstance(context);
