...
//import static com.razorpay.n$$t$.i;
...
public class CarRoullete_A extends BaseActivity implements View.OnClickListener {
    ...
    TextView txtName, txtBallence, txt_gameId, txtGameRunning, txtGameBets, tvWine, tvLose,tvTotalbet;
    Button btGameAmount;
...
//added new vibration
    ...
    private void Initialization() {
        ...
        tvTotalbet=findViewById(R.id.totalbet);//new for total bet
    ...
    private void setSetRulesValue() {
        ...
        for (int i = 0; i < gameroulate_String.length; i++) {
            ...
            rulesModelList.add(new CarRollouteModel(bonus,item,item_icon, i + 1, 0, 0,""));
        }
...
//                txtview.setTextColor(ContextCompat.getColor(this,R.color.colorPrimary));
    ...
    private void initiAnimation() {
        ...
        blinksAnimation.setStartOffset(900);
    }
                ...
                if (resp != null) {
                    try {
                        ...
                        if (code.equalsIgnoreCase("200")) {
                           ...
                           /* JSONArray last_bet=jsonObject.getJSONArray("last_bet");
                            for (int i = 0; i < last_bet.length(); i++) {
                                JSONObject profileObject = last_bet.getJSONObject(i);*/
                     ...
                     //       Log.d("Debug","total_amount"+last_winning);
                            ...
                            int toyotaAmount = jsonData_1.getInt("toyota_amount");
                            int mahindraAmount = jsonData_1.getInt("mahindra_amount");
                            int audiAmount = jsonData_1.getInt("audi_amount");
                            int bmwAmount = jsonData_1.getInt("bmw_amount");
                            int mercedesAmount = jsonData_1.getInt("mercedes_amount");
                            int porscheAmount = jsonData_1.getInt("porsche_amount");
                            int lamborghiniAmount = jsonData_1.getInt("lamborghini_amount");
                            int ferrariAmount = jsonData_1.getInt("ferrari_amount");

                            int totalAmount = toyotaAmount + mahindraAmount + audiAmount + bmwAmount
                                    + mercedesAmount + porscheAmount + lamborghiniAmount + ferrariAmount;
                            ...
                            if (last_winning.length() > 0 && lnrcancelist != null) {
                               ...
                               /*  total_amount =jsonObject.getInt("total_amount");
                                ((TextView)findViewById(R.id.totalbet)).setText(""+total_amount);*/
                            }
...
//                                main_card  = welcome_bonusObject.getString("main_card");
                          ...
                          /*  int total_amount =jsonObject.getInt("total_amount");
                            ((TextView)findViewById(R.id.totalbet)).setText(""+total_amount);*/
...
//                            VisiblePleasewaitforNextRound(true);
    ...
    private void addLastWinBetonView(JSONArray last_bet) throws JSONException {
        ...
        for (int i = 0; i < last_bet.length(); i++) {
          ...
          /*  int total_amount =last_bet.getJSONObject(i).getInt("total_amount");
            ((TextView)findViewById(R.id.totalbet)).setText(""+total_amount);*/
                ...
                if (resp != null) {
                    try {
                        ...
                        if (code.equalsIgnoreCase("200")) {
                            ...
                            //  tvTotalbet=jsonObject.getString("")
                            txtBallence.setText(wallet);
...
//        }
    ...
    public void openGameRules(View view) {
        DialogRuleCarRoulette.getInstance(context).show();
    }
