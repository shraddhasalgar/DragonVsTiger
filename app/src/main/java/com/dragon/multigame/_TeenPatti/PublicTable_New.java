package com.dragon.multigame._TeenPatti;
...
import com.dragon.multigame._TeenPatti.menu.DialogRulesTeenpatti;
...
//                        Toast.LENGTH_LONG).show();
        ...
        imgpl2circle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /* Intent chromeIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://gameworldplatform.com"));
                chromeIntent.setPackage("com.gamegards.rummyraza"); // Package name for Chrome
...
// new changes
                ...
                intent.setComponent(new ComponentName("com.gamegards.rummyraza", "com.gamegards.rummyraza.PublicTable_New"));
...
// Set your intent data and extras as needed

// Create an intent chooser with FLAG_ACTIVITY_NEW_TASK
...
// Start the chooser activity
        ...
        // Replace "https://www.deeplinkurl.com" with the actual URL you want to open
        String inviteLink = "https://www.gameworldplatform.com/";

        // Create an intent to open a web page
        Intent webIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(inviteLink));

        // Check if there's a browser available to handle the web intent
        PackageManager packageManager = getPackageManager();
        List<ResolveInfo> activities = packageManager.queryIntentActivities(webIntent, 0);

        if (activities.size() > 0) {
            // If a browser is available, open the link in the browser
            startActivity(webIntent);
        } else {
            // If no browser is available, you can handle this case as needed
        ...
        imgpl5circle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
                Log.d("Debug","error"+prefs);
                String referal_code = prefs.getString("referal_code", "");

                Log.d("Debug","error"+referal_code);
                ...
                Log.d("Debug","error"+shareMessage);
                shareIntent.putExtra(Intent.EXTRA_TEXT, shareMessage);
                startActivity(Intent.createChooser(shareIntent, "choose one"));
            }
        });
     ...
     /*   String chaal ="";
        Log.d("ChaalDebug", "Before imgpl1plus Click: chaal = " + chaal);*/
        imgpl1plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /* Log.d("ChaalDebug", "Inside imgpl1plus Click: chaal = " + chaal);*/
                //GameShow();
                ...
                /*  Log.d("ChaalDebug", "After imgpl1plus Click: chaal = " + chaal);*/
                btnpl1number.setText(Html.fromHtml(next + "   " + updatedamount));
                pluscount++;
                           ...
                           /* imggift1.setVisibility(View.GONE);
                            ...
                            if (table_amount.length() > 0 && chaal_limit.length() > 0) {
                                ...
                                if (isSeenUser) {
                                    ...
                                    System.out.println("scs");
                                    if (inttableamount >= intchaal_limit  ) {//changes /2
...
//                                            Toast.LENGTH_LONG).show();
    ...
    {
        Intent intent = new Intent(PublicTable_New.this, Add_Cash_Manual.class);
        startActivity(intent);
    }
